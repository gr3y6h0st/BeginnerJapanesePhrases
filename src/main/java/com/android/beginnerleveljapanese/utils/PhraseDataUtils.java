...
public class PhraseDataUtils {
    ...
    private static ContentValues createPhraseContentValues (String phraseCategory, String english_text, String romaji_text, Boolean favBool) {
        ...
        phraseDataValues.put(FavoritesContract.FavoriteEntry.COLUMN_FAVORITE_BOOL, favBool.toString());
        return  phraseDataValues;
    }

    public static void insertPhraseData(Context context, String phrase_category, String[] englishTextArr, String[] romajiTextArr){
